...
namespace Solitaire.Helpers
{
    public static class CardHelper
    {
        ...
        private static bool IsBlack(Card card) => card.Type == CardType.Spade || card.Type == CardType.Clover;
        ...
        private static bool IsRed(Card card) => card.Type == CardType.Heart || card.Type == CardType.Diamond;
        ...
        private static bool IsInSequence(Card higher, Card lower) => higher.Value == lower.Value + 1;
        ...
        private static bool IsSameSuit(Card first, Card second) => first.Type == second.Type;
    }
}
