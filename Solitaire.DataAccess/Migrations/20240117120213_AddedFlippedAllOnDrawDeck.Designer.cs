...
namespace Solitaire.DataAccess.Migrations
{
    ...
    [Migration("20240117120213_AddedFlippedAllOnDrawDeck")]
    partial class AddedFlippedAllOnDrawDeck
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solitaire.Models.Draw", b =>
                {
                    ...
                    b.Property<bool>("FlippedAllOnDrawDeck")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Solitaire.Models.Score", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Solitaire.Models.Score", b =>
                {
                    b.HasOne("Solitaire.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Scores")
